...
for iter in range(Iter):
    PosterPro_data1=getPosterPro(K,data1,sigma_X1,mean_X1)
    likelihoodLabel=getLikelihoodLabel(PosterPro_data1)
    errorRate=getErrorRate(N,label,likelihoodLabel)
    errorSum+=errorRate
errorAver=errorSum/Iter
#print 'The error rate of Likelihood Rate rule is(X1)',errorAver
'''
